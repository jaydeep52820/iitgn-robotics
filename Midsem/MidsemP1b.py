...
for i in range(12):
    if i == 0:
        a = input("Enter x coordinate of Point A (should be between 25 & 45): ")
        A.append(float(a))
    if i == 1:
        a = input("Enter y coordinate of Point A (should be between -7.5 & 7.5): ")
        A.append(float(a))
    if i == 2:
        print("z coordinate of Point A fixed as 10")
        A.append(10)
    if i == 3:
        a = input("Enter x coordinate of Point B (should be between 25 & 45): ")
        B.append(float(a))
    if i == 4:
        a = input("Enter y coordinate of Point B (should be between -7.5 & 7.5): ")
        B.append(float(a))
    if i == 5:
        print("z coordinate of Point B fixed as 10")
        B.append(10)
    if i == 6:
        a = input("Enter x coordinate of Point C (should be between 25 & 45): ")
        C.append(float(a))
    if i == 7:
        a = input("Enter y coordinate of Point C (should be between -7.5 & 7.5): ")
        C.append(float(a))
    if i == 8:
        print("z coordinate of Point C fixed as 10")
        C.append(10)
    if i == 9:
        a = input("Enter x coordinate of Point D (should be between 25 & 45): ")
        D.append(float(a))
    if i == 10:
        a = input("Enter y coordinate of Point D (should be between -7.5 & 7.5): ")
        D.append(float(a))
    if i == 11:
        print("z coordinate of Point D fixed as 10")
        D.append(10)
