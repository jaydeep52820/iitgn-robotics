...
def modelD(y, t, m1, m2, m3, l1, l2, l3, r1, r2, r3, J1, J2, J3, g, yda, ydb):
    ...
    U = np.matmul(MM, aq) + np.matmul(C, np.transpose([theta1d, theta2d, dd])) + G
...
def modelB(y, t, m1, m2, m3, l1, l2, l3, r1, r2, r3, J1, J2, J3, g, yda, ydb):
    ...
    u1 = 2 * e1 + 1 * e1_d + (alpha + beta + 2*gamma*np.cos(theta2) + 0.01)*d_theta1dd
    u2 = 2 * e2 + 1 * e2_d + + (beta + 0.01)*d_theta2dd
